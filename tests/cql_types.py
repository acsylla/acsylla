...
native_types = {
    ...
    "timestamp": {
        ...
        "valid": [
            (
                datetime.fromisoformat("2022-12-15 22:23:26.538+00:00"),
                ("2022-12-15 22:23:26.538Z", datetime.fromisoformat("2022-12-15 22:23:26.538+00:00")),
            ),
            (datetime(1, 1, 1, 0, 0, 0), ("0001-01-01 00:00:00.000Z", datetime(1, 1, 1, 0, 0, 0, tzinfo=UTC))),
            (datetime(1, 2, 3, 4, 5, 6), ("0001-02-03 04:05:06.000Z", datetime(1, 2, 3, 4, 5, 6, tzinfo=UTC))),
            (datetime(1, 2, 28, 4, 5, 6), ("0001-02-28 04:05:06.000Z", datetime(1, 2, 28, 4, 5, 6, tzinfo=UTC))),
            (datetime(400, 4, 2, 4, 5, 6, 7), ("0400-04-02 04:05:06.000Z", datetime(400, 4, 2, 4, 5, 6, tzinfo=UTC))),
            (
                datetime(400, 4, 2, 4, 5, 6, 7000),
                ("0400-04-02 04:05:06.007Z", datetime(400, 4, 2, 4, 5, 6, 7000, tzinfo=UTC)),
            ),
            (
                datetime(400, 12, 31, 4, 5, 6, 7),
                ("0400-12-31 04:05:06.000Z", datetime(400, 12, 31, 4, 5, 6, tzinfo=UTC)),
            ),
            (datetime(500, 1, 1, 4, 5, 6, 7), ("0500-01-01 04:05:06.000Z", datetime(500, 1, 1, 4, 5, 6, tzinfo=UTC))),
            (datetime(500, 2, 28, 4, 5, 6, 7), ("0500-02-28 04:05:06.000Z", datetime(500, 2, 28, 4, 5, 6, tzinfo=UTC))),
            (datetime(800, 2, 29, 4, 5, 6, 7), ("0800-02-29 04:05:06.000Z", datetime(800, 2, 29, 4, 5, 6, tzinfo=UTC))),
            (
                datetime(1200, 2, 29, 4, 5, 6, 7),
                ("1200-02-29 04:05:06.000Z", datetime(1200, 2, 29, 4, 5, 6, tzinfo=UTC)),
            ),
            (datetime(1200, 1, 1, 0, 0, 0), ("1200-01-01 00:00:00.000Z", datetime(1200, 1, 1, 0, 0, 0, tzinfo=UTC))),
            (
                datetime(1600, 2, 29, 4, 5, 6, 7),
                ("1600-02-29 04:05:06.000Z", datetime(1600, 2, 29, 4, 5, 6, tzinfo=UTC)),
            ),
            (
                datetime(1969, 2, 28, 4, 5, 6, 7),
                ("1969-02-28 04:05:06.000Z", datetime(1969, 2, 28, 4, 5, 6, tzinfo=UTC)),
            ),
            (datetime(1969, 3, 1, 4, 5, 6, 7), ("1969-03-01 04:05:06.000Z", datetime(1969, 3, 1, 4, 5, 6, tzinfo=UTC))),
            (datetime(1970, 1, 1, 0, 0, 0, 0), ("1970-01-01 00:00:00.000Z", datetime(1970, 1, 1, 0, 0, 0, tzinfo=UTC))),
            (datetime(2022, 1, 1, 0, 0, 0, 0), ("2022-01-01 00:00:00.000Z", datetime(2022, 1, 1, 0, 0, 0, tzinfo=UTC))),
            (datetime(2400, 3, 1, 4, 5, 6, 7), ("2400-03-01 04:05:06.000Z", datetime(2400, 3, 1, 4, 5, 6, tzinfo=UTC))),
            (datetime(9400, 3, 1, 4, 5, 6, 7), ("9400-03-01 04:05:06.000Z", datetime(9400, 3, 1, 4, 5, 6, tzinfo=UTC))),
            ("2022-02-12 12:34:23", ("2022-02-12 12:34:23.000Z", datetime(2022, 2, 12, 12, 34, 23, tzinfo=UTC))),
            (
                "2022-02-12 12:34:23+02:00",
                ("2022-02-12 10:34:23.000Z", datetime.fromisoformat("2022-02-12 10:34:23+00:00")),
            ),
            (1671049801.789601, ("2022-12-14 20:30:01.789Z", datetime(2022, 12, 14, 20, 30, 1, 789000, tzinfo=UTC))),
            (1671049801, ("2022-12-14 20:30:01.000Z", datetime(2022, 12, 14, 20, 30, 1, tzinfo=UTC))),
            (
                datetime(2025, 3, 30, 3, 4, 5, 999),
                ("2025-03-30 03:04:05.000Z", datetime(2025, 3, 30, 3, 4, 5, tzinfo=UTC)),
            ),
            (
                datetime(2025, 3, 30, 3, 4, 5, 1000),
                ("2025-03-30 03:04:05.001Z", datetime(2025, 3, 30, 3, 4, 5, 1000, tzinfo=UTC)),
            ),
            (
                datetime(2025, 3, 30, 3, 4, 5, 1001),
                ("2025-03-30 03:04:05.001Z", datetime(2025, 3, 30, 3, 4, 5, 1000, tzinfo=UTC)),
            ),
            (
                datetime(2025, 3, 30, 3, 4, 5, 2500),
                ("2025-03-30 03:04:05.002Z", datetime(2025, 3, 30, 3, 4, 5, 2000, tzinfo=UTC)),
            ),
            (
                datetime.fromisoformat("2022-12-15 22:23:26.538+01:00"),
                ("2022-12-15 21:23:26.538Z", datetime.fromisoformat("2022-12-15 21:23:26.538+00:00")),
            ),
        ],
