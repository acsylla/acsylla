...
native_types = {
    ...
    "date": {
        "valid": [
            ("2022-12-14", (1670976000, date(2022, 12, 14))),
            ("2022-12-14 18:34", (1670976000, date(2022, 12, 14))),
            (datetime(2022, 12, 14, 18, 34, 12), (1670976000, date(2022, 12, 14))),
            ("2022-12-14 18:34+02:00", (1670976000, date(2022, 12, 14))),
            (1671036203.636648, (1670976000, date(2022, 12, 14))),
            (1671036203, (1670976000, date(2022, 12, 14))),
            (-62105616000.0, (-62105616000, date(1, 12, 14))),
            (-62105616000, (-62105616000, date(1, 12, 14))),
        ],
    ...
    "time": {
        "valid": [
            (86300.999999999, (86300.999999999, time(23, 58, 20, 999999))),
            ("17:12:32.999999", (61952.999999, time(17, 12, 32, 999999))),
            (time(12, 24, 36), (44676.0, time(12, 24, 36))),
            ("12:24", (44640.0, time(12, 24))),
            (datetime(1, 2, 3, 4, 5, 6, 7), (14706.000007, time(4, 5, 6, 7))),
            (45299.1234567, (45299.1234567, time(12, 34, 59, 123456))),
        ],
    ...
    "timestamp": {
        "valid": [
            (
                ...
                (1671143006.538, datetime.fromisoformat("2022-12-15 22:23:26.538")),
            ),
            (datetime(1, 2, 3, 4, 5, 6, 7), (-62132730893.999, datetime(1, 2, 3, 4, 5, 6, 999))),
            ("2022-02-12 12:34:23", (1644669263.0, datetime(2022, 2, 12, 12, 34, 23))),
            ("2022-02-12 12:34:23+02:00", (1644662063.0, datetime.fromisoformat("2022-02-12 10:34:23"))),
            (1671049801.789601, (1671049801.789, datetime(2022, 12, 14, 20, 30, 1, 789000))),
            (1671049801, (1671049801.0, datetime(2022, 12, 14, 20, 30, 1))),
        ],
